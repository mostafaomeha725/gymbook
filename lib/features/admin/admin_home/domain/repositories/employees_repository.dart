...
abstract class EmployeesRepository {
  ...
  Stream<Either<Failure, BranchEmployeesResponse>> getBranchEmployees(int branchId, int pageNumber);
  Future<Either<Failure, EmployeeModel>> addEmployee(Map<String, dynamic> body);
  Future<Either<Failure, EmployeeModel>> updateEmployee(int employeeId, Map<String, dynamic> body);
}
